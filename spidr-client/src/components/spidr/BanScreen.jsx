          ...
          <div className="flex items-center justify-center gap-2 text-gray-400">
            ...
            {isPermanent ? (
              ...
              <span className="text-sm">
                Expires: <span className="text-white font-bold">{moment(banExpiry).format('MMM D, YYYY [at] h:mm A')}</span>
                <span className="text-gray-600 ml-1">({moment(banExpiry).fromNow()})</span>
              </span>
            )}
          </div>
        </div>
