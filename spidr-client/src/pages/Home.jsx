...
export default function HomeContent() {
  ...
  const handleNavigateToDM = (_friendId, conversationId) => navigate('/friends/@me/' + conversationId);
      ...
      <div className="flex gap-6 p-6 max-w-[1400px] mx-auto">
        ...
        <div className="flex-1 min-w-0 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={() => navigate('/friends')}
            ...
            <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={() => navigate('/ai')}
          ...
          {/* AI User Discovery */}
          <DiscoverUsers currentUser={currentUser} onNavigateToDM={handleNavigateToDM} />
        ...
        <div className="w-72 shrink-0 hidden lg:block">
          <EngagementHub currentUser={currentUser} onNavigate={navigate} onNavigateToDM={handleNavigateToDM} />
        </div>
      </div>
    </div>
  );
