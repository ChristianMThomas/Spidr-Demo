  ...
  return (
    <html lang="en">
      <body>
        <Providers>
          <div
            className="bg-black w-full box-border"
            style={{ minWidth: '900px', minHeight: '550px', height: '100%', overflow: 'hidden' }}
          >
            <style>{`
              :root {
                --background: 0 0% 0%;
              ...
              * { scrollbar-width: thin; scrollbar-color: #991b1b transparent; }
              *::-webkit-scrollbar { width: 6px; height: 0px; }
              *::-webkit-scrollbar-track { background: transparent; }
              *::-webkit-scrollbar-thumb { background: #991b1b; border-radius: 3px; }
              *::-webkit-scrollbar-thumb:hover { background: #dc2626; }

              body { background: #000; color: #fff; font-family: 'Inter', -apple-system, BlinkMacSystemFont, sans-serif; }

              .glass { background: rgba(0,0,0,0.7); backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); }
              .glass-light { background: rgba(255,255,255,0.1); backdrop-filter: blur(20px); -webkit-backdrop-filter: blur(20px); }

              .glass-bubble {
                position: relative; padding: 12px 24px; border-radius: 24px;
              ...
              .bubble-out {
                ...
                border: 1px solid rgba(229,62,62,0.3); color: white;
                border-bottom-right-radius: 4px; text-align: right;
                box-shadow: 0 0 15px rgba(229,62,62,0.05);
              }
              .thread-line {
                position: absolute; left: 20px; top: 40px; bottom: -20px; width: 2px;
                background: linear-gradient(to bottom, #333, transparent); z-index: 0;
              }
              .thread-line.active {
