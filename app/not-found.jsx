      ...
      <div className="max-w-md w-full relative z-10">
        <div className="text-center space-y-6 bg-zinc-900/50 backdrop-blur-xl border border-red-900/30 rounded-2xl p-8">
          <div className="space-y-2">
            ...
            <div className="h-1 w-16 bg-gradient-to-r from-red-600 to-red-400 mx-auto rounded-full" />
          </div>

          <div className="space-y-3">
            <h2 className="text-2xl font-bold text-white">Lost in the Web</h2>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="text-left space-y-1">
                  ...
                  <p className="text-sm text-zinc-400 leading-relaxed">
                    This page hasn't been implemented yet. Add a new route in the app/ directory.
                  </p>
                </div>
              </div>
            </div>
