...
import { Globe, ShieldCheck, Zap, Loader2, Search } from 'lucide-react';
...
export default function ImportBotTab({ currentUser }) {
  ...
  const importMutation = useMutation({
    mutationFn: async () => {
      ...
      const bot = await base44.entities.CustomBot.create({
...
Be reasonable — most Discord bots are safe.`,
      ...
      await base44.entities.CustomBot.update(bot.id, {
        status,
