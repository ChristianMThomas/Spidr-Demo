...
export default function SettingsPanel({ currentUser, appTheme, onThemeChange }) {
  ...
  return (
    <div className="flex-1 flex flex-col bg-zinc-900 relative">
        ...
        <div className="flex-1 overflow-y-auto">
          <TabsContent value="profile" className="p-6 m-0">
            ...
            <div className="bg-zinc-800 rounded-2xl overflow-hidden mb-6">
              {/* Banner */}
              <div className="h-32 relative bg-gradient-to-r from-red-900 to-red-700">
                {formData.banner_url && (
                  <img src={formData.banner_url} alt="Banner" className="w-full h-full object-cover" />
                )}
                <label className="absolute inset-0 flex items-center justify-center bg-black/50 opacity-0 hover:opacity-100 transition-opacity cursor-pointer">
                  <input type="file" accept="image/*,.gif" className="hidden" onChange={(e) => handleFileUpload(e, 'banner_url')} />
              ...
              <div className="px-6 pb-6">
                <div className="relative -mt-12 mb-4">
                  ...
                  <label className="absolute inset-0 w-24 h-24 flex items-center justify-center bg-black/50 rounded-full opacity-0 hover:opacity-100 transition-opacity cursor-pointer">
                    <input type="file" accept="image/*,.gif" className="hidden" onChange={(e) => handleFileUpload(e, 'avatar_url')} />
            ...
            <div className="space-y-4 max-w-lg">
              ...
              <div>
                <Label className="text-zinc-300">Avatar URL (supports GIFs!)</Label>
                <Input
              ...
              <div>
                <Label className="text-zinc-300">Banner URL (supports GIFs!)</Label>
                <Input
      ...
      {/* APEX Store */}
      <ApexStore isOpen={showApexStore} onClose={() => setShowApexStore(false)} currentTier={profile?.apex_tier} />
    </div>
  );
}