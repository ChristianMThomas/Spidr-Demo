...
import { Heart, MessageCircle, Share2, Pin, TrendingUp, Users, Award, Megaphone, Zap } from 'lucide-react';
...
export default function EnhancedFeed({ currentUser }) {
  ...
  const { data: feedItems = [], isLoading } = useQuery({
    ...
    queryFn: () => base44.entities.Feed.list('-created_date', 30),
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-0.5">
            ...
            <span className="text-zinc-600 text-[10px] ml-auto shrink-0">{formatDistanceToNow(new Date(item.created_date), { addSuffix: true })}</span>
          </div>
