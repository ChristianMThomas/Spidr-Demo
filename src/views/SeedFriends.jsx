  ...
  return (
    <div className="min-h-screen bg-zinc-900 flex items-center justify-center p-8">
      <div className="bg-zinc-800 rounded-2xl p-8 border border-red-900/20 max-w-md w-full">
        <Link href="/" className="inline-flex items-center text-red-500 hover:text-red-400 mb-4">
        ...
        <p className="text-zinc-500 text-sm mt-4">
          After creating, go to the <Link href="/" className="text-red-500 hover:underline">Friends tab</Link> to see the story-style DM carousel at the top!
        </p>
      </div>
    </div>
  );
